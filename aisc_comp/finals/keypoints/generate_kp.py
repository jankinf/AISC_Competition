import os
import cv2
from keypoints import inference
from PIL import Image, ImageDraw
import pickle
import argparse
ap = argparse.ArgumentParser()
ap.add_argument("-r", "--img_dir", required=True, help="path to root directories of input images")
ap.add_argument("-d", "--outfile", required=True, help="path to destination directories of output images")
...
def run_imgs():
    ...
    # outfile = "/data/projects/aisc_facecomp/finals/keypoints/kpoints.pkl"
    # outfile = "/data/projects/aisc_facecomp/finals/keypoints/kpoints224.pkl"
