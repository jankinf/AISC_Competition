...
do
    ...
    nohup rlaunch --cpu 1 --memory 5394 -- python -m attack.eval_uni640_origrp_detector+model \
    --i_net panorama.i_epoch_202622.th_0.8308.neupeak \
    --pattern $path \
    --name "${array[6]}/${array[7]}/${array[8]}" > eval_uni640_origrp_detector+model.out &
    # python -m attack.eval_uni640_origrp_detector+model \
    # --i_net panorama.i_epoch_202622.th_0.8308.neupeak \
    # --pattern $path \
